...
if __name__ == "__main__":
    ...
    #'/home/jetbot/catkin_ws/src/ros_jetbot/ost.yaml'#
    filename = rospy.get_param('camera_info/param')
    print(filename)
    ...
    publisher = rospy.Publisher("/jetbot/camera_info", CameraInfo, queue_size=10)
    rate = rospy.Rate(10)
